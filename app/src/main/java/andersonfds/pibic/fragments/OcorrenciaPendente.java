...
public class OcorrenciaPendente extends Fragment implements RecyclerViewClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.ocPendRecycler);
        setRecyclerView();
        retrieveData();
    ...
    private void retrieveData() {
        repository.selectPendContacts().observe(this, items -> {
